    ...
    <section className="relative overflow-hidden bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2">
          <div className="relative w-full h-80 md:h-96 rounded-[48px] overflow-hidden shadow-lg">
            <Image
              src="/images/hero.jpg"
              alt="Pintores profissionais da Ricardo Pinturas"
              fill
        ...
        <div className="md:w-1/2 relative">
          ...
          {/* Banner / selo */}
          <div className="absolute top-0 right-0 bg-red-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
            Promoção
          </div>
