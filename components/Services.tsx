...
const services = [
  { title: "Pintura Interna", img: "/images/hero.jpg" },
  { title: "Pintura Externa", img: "/images/hero.jpg" },
  { title: "Acabamento em Fibra de Cimento", img: "/images/hero.jpg" },
  { title: "Revestimento Board and Batten", img: "/images/hero.jpg" },
];
